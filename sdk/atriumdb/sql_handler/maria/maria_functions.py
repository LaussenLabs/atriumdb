...
maria_select_device_from_id_query = "SELECT * FROM device WHERE id = ?"
maria_select_device_from_tag_query = "SELECT * FROM device WHERE tag = ?"
...
"""
maria_select_blocks_from_file = "SELECT * FROM block_index WHERE file_id = ? ORDER BY start_byte;"
maria_delete_block_query = "DELETE FROM block_index WHERE id = ?;"

maria_select_file_by_id = "SELECT * FROM file_index WHERE id = ?;"
maria_select_file_by_values = """SELECT * FROM file_index WHERE path = ?;"""

maria_select_interval_by_id = "SELECT * FROM interval_index WHERE id = ?;"
maria_select_interval_by_values = """SELECT * FROM interval_index 
...
maria_insert_ignore_patient_query = "INSERT IGNORE INTO patient (mrn, gender, dob, first_name, middle_name, last_name, first_seen, last_updated, source_id) " \
                                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);"
