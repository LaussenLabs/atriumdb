...
def verify_definition(definition, sdk, gap_tolerance=None, measure_tag_match_rule="best", start_time_n=None,
    ...
    :param DatasetDefinition definition: The dataset definition to be verified. This can be either a filename (str) pointing to a dataset definition file or an instance of DatasetDefinition.
